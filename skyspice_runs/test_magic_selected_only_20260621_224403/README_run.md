...
- Layout: `test_magic_selected_only.gds`
- Full JSON report: `test_magic_selected_only.gds.report.json`
- Topology: `test_magic_selected_only.gds.topology.json`
- Routing plan: `test_magic_selected_only.gds.routing_plan.csv`
- Common-centroid plan: `test_magic_selected_only.gds.common_centroid_plan.json`
- Unit arrays: `test_magic_selected_only.gds.unit_arrays.csv`
- Warnings: `test_magic_selected_only.gds.layout_warnings.csv`
