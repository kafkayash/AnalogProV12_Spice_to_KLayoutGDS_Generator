...
- Layout: `test_schematic_placement.gds`
- Full JSON report: `test_schematic_placement.gds.report.json`
- Topology: `test_schematic_placement.gds.topology.json`
- Routing plan: `test_schematic_placement.gds.routing_plan.csv`
- Common-centroid plan: `test_schematic_placement.gds.common_centroid_plan.json`
- Unit arrays: `test_schematic_placement.gds.unit_arrays.csv`
- Warnings: `test_schematic_placement.gds.layout_warnings.csv`
