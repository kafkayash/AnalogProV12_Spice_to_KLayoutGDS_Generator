...
- Layout: `BGR_sky130_ckt_wizard.gds`
- Full JSON report: `BGR_sky130_ckt_wizard.gds.report.json`
- Topology: `BGR_sky130_ckt_wizard.gds.topology.json`
- Routing plan: `BGR_sky130_ckt_wizard.gds.routing_plan.csv`
- Common-centroid plan: `BGR_sky130_ckt_wizard.gds.common_centroid_plan.json`
- Unit arrays: `BGR_sky130_ckt_wizard.gds.unit_arrays.csv`
- Warnings: `BGR_sky130_ckt_wizard.gds.layout_warnings.csv`
