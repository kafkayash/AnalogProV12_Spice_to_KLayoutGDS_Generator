...
- Layout: `test_wizard_v12.gds`
- Full JSON report: `test_wizard_v12.gds.report.json`
- Topology: `test_wizard_v12.gds.topology.json`
- Routing plan: `test_wizard_v12.gds.routing_plan.csv`
- Common-centroid plan: `test_wizard_v12.gds.common_centroid_plan.json`
- Unit arrays: `test_wizard_v12.gds.unit_arrays.csv`
- Warnings: `test_wizard_v12.gds.layout_warnings.csv`
