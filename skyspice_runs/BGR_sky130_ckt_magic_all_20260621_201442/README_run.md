...
- Layout: `BGR_sky130_ckt_magic_all.gds`
- Full JSON report: `BGR_sky130_ckt_magic_all.gds.report.json`
- Topology: `BGR_sky130_ckt_magic_all.gds.topology.json`
- Routing plan: `BGR_sky130_ckt_magic_all.gds.routing_plan.csv`
- Common-centroid plan: `BGR_sky130_ckt_magic_all.gds.common_centroid_plan.json`
- Unit arrays: `BGR_sky130_ckt_magic_all.gds.unit_arrays.csv`
- Warnings: `BGR_sky130_ckt_magic_all.gds.layout_warnings.csv`
