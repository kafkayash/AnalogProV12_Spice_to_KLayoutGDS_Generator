...
- Layout: `docs_wizard_showcase.gds`
- Full JSON report: `docs_wizard_showcase.gds.report.json`
- Topology: `docs_wizard_showcase.gds.topology.json`
- Routing plan: `docs_wizard_showcase.gds.routing_plan.csv`
- Common-centroid plan: `docs_wizard_showcase.gds.common_centroid_plan.json`
- Unit arrays: `docs_wizard_showcase.gds.unit_arrays.csv`
- Warnings: `docs_wizard_showcase.gds.layout_warnings.csv`
