...
- Layout: `test_ratlines.gds`
- Full JSON report: `test_ratlines.gds.report.json`
- Topology: `test_ratlines.gds.topology.json`
- Routing plan: `test_ratlines.gds.routing_plan.csv`
- Common-centroid plan: `test_ratlines.gds.common_centroid_plan.json`
- Unit arrays: `test_ratlines.gds.unit_arrays.csv`
- Warnings: `test_ratlines.gds.layout_warnings.csv`
