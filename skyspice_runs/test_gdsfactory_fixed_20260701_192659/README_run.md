...
- Layout: `test_gdsfactory_fixed.gds`
- Full JSON report: `test_gdsfactory_fixed.gds.report.json`
- Topology: `test_gdsfactory_fixed.gds.topology.json`
- Routing plan: `test_gdsfactory_fixed.gds.routing_plan.csv`
- Common-centroid plan: `test_gdsfactory_fixed.gds.common_centroid_plan.json`
- Unit arrays: `test_gdsfactory_fixed.gds.unit_arrays.csv`
- Warnings: `test_gdsfactory_fixed.gds.layout_warnings.csv`
