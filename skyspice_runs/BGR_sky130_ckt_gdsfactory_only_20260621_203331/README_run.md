...
- Layout: `BGR_sky130_ckt_gdsfactory_only.gds`
- Full JSON report: `BGR_sky130_ckt_gdsfactory_only.gds.report.json`
- Topology: `BGR_sky130_ckt_gdsfactory_only.gds.topology.json`
- Routing plan: `BGR_sky130_ckt_gdsfactory_only.gds.routing_plan.csv`
- Common-centroid plan: `BGR_sky130_ckt_gdsfactory_only.gds.common_centroid_plan.json`
- Unit arrays: `BGR_sky130_ckt_gdsfactory_only.gds.unit_arrays.csv`
- Warnings: `BGR_sky130_ckt_gdsfactory_only.gds.layout_warnings.csv`
