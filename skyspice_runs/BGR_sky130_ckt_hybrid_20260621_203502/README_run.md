...
- Layout: `BGR_sky130_ckt_hybrid.gds`
- Full JSON report: `BGR_sky130_ckt_hybrid.gds.report.json`
- Topology: `BGR_sky130_ckt_hybrid.gds.topology.json`
- Routing plan: `BGR_sky130_ckt_hybrid.gds.routing_plan.csv`
- Common-centroid plan: `BGR_sky130_ckt_hybrid.gds.common_centroid_plan.json`
- Unit arrays: `BGR_sky130_ckt_hybrid.gds.unit_arrays.csv`
- Warnings: `BGR_sky130_ckt_hybrid.gds.layout_warnings.csv`
